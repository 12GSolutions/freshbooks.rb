...
Gem::Specification.new do |s|
  s.name = %q{12g-freshbooks}
  s.version = "0.1.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Ben Curren", "Maxime Rousseaux-Bridle"]
  s.date = %q{2012-07-04}
